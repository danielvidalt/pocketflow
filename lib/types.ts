...
export type RecurringExpense = { id:string; user_id:string; name:string; amount:number; category:ExpenseCategory; frequency:'weekly'|'fortnightly'|'monthly'; is_active:boolean; start_date:string; created_at:string }
