...
export type ExpenseCategory = 'food'|'supermarket'|'transport'|'leisure'|'shopping'|'health'|'housing'|'subscriptions'|'other'
export const CAT_LABELS: Record<ExpenseCategory, string> = { food:'Comida', supermarket:'Supermercado', transport:'Transporte', leisure:'Ocio', shopping:'Compras', health:'Salud', housing:'Vivienda', subscriptions:'Suscripciones', other:'Otro' }
export const CAT_COLORS: Record<ExpenseCategory, string> = { food:'#1D9E75', supermarket:'#2E8B57', transport:'#534AB7', leisure:'#BA7517', shopping:'#993556', health:'#3B6D11', housing:'#185FA5', subscriptions:'#D85A30', other:'#5F5E5A' }
