...
export type Expense = { id:string; user_id:string; name:string; amount:number; category:ExpenseCategory; expense_date:string; is_recurring:boolean; note:string|null; income_source_id?:string|null; created_at:string }
...
export type FixedExpenseAllocation = { id:string; user_id:string; recurring_expense_id:string; amount:number; allocated_at:string; expense_id:string|null; type:'deposit'|'withdrawal'; note:string|null; created_at:string }
export type SavingsWithdrawal = { id:string; user_id:string; savings_goal_id:string; expense_id:string|null; amount:number; withdrawn_at:string; note:string|null; created_at:string }
